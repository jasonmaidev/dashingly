        ...
        <div className='grid lg:grid-cols-5 gap-4 px-8 pt-4'>
            ...
            >
                <div className='flex flex-col w-full pb-4'>
                    <p className='text-2xl font-bold' suppressHydrationWarning>{dailyTotal}</p>
            ...
            <div className={
                ...
                <div className='flex flex-col w-full pb-4'>
                    <p className='text-2xl font-bold' suppressHydrationWarning>{yearTotal}</p>
            ...
            <div className='flex justify-between w-full shadow-xl p-8 rounded-3xl'>
                <div className='flex flex-col w-full pb-4'>
                    <p className='text-2xl font-bold' suppressHydrationWarning>{totalCustomers}</p>
